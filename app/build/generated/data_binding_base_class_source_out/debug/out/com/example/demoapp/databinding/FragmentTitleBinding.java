...
public final class FragmentTitleBinding implements ViewBinding {
  ...
  private FragmentTitleBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnStart) {
  ...
  public static FragmentTitleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTitleBinding((ConstraintLayout) rootView, btnStart);
    }
