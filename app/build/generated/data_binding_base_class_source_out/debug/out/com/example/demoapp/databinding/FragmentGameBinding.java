...
public final class FragmentGameBinding implements ViewBinding {
  ...
  private FragmentGameBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnStart) {
  ...
  public static FragmentGameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGameBinding((ConstraintLayout) rootView, btnStart);
    }
